...
const DigitalMenu = () => {
  ...
  const features = [{
    icon: Languages,
    title: "30+ Languages",
    description: "Auto-translate your menu for international guests"
  }, {
    icon: DollarSign,
    title: "Multi-Currency",
    description: "Real-time currency conversion for travelers"
  }, {
    icon: Utensils,
    title: "Nutrition Info",
    description: "Display calories, allergens, and dietary tags"
  }, {
    icon: Clock,
    title: "Prep Times",
    description: "Set expectations with estimated wait times"
  }, {
    icon: Star,
    title: "Customer Reviews",
    description: "Show ratings to help customers choose"
  }, {
    icon: Bot,
    title: "AI Descriptions",
    description: "Generate enticing descriptions automatically"
  }];
  const benefits = [{
    icon: Zap,
  ...
  const steps = [{
    number: "01",
    title: "Create",
    description: "Upload your menu items with photos and descriptions"
  }, {
    number: "02",
    title: "Customize",
    description: "Choose your design, colors, and enable features"
  }, {
    number: "03",
    title: "Share",
    description: "Generate a QR code or link to share with customers"
  }];
  const testimonials = [{
    name: "Marco R.",
    role: "Fine Dining Owner",
    quote: "Our international guests love being able to view the menu in their language."
  }, {
    name: "Sarah L.",
    role: "Café Manager",
    quote: "We update specials daily without printing anything. Game changer!"
  }, {
    name: "Ahmed K.",
    role: "Restaurant Chain",
    quote: "Rolling out menu changes across 12 locations takes minutes now."
  }];
          ...
          <div className="container-custom">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {features.map((feature, index) => <div key={index} className={`animate-on-scroll animate-delay-${(index + 1) * 100} group bg-gray-50 hover:bg-white rounded-2xl p-6 border border-transparent hover:border-primary/20 hover:shadow-xl transition-all duration-500 hover:-translate-y-1`}>
          ...
          <div className="container-custom">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {benefits.map((benefit, index) => <div key={index} className={`animate-on-scroll animate-delay-${(index + 1) * 100} group bg-white rounded-2xl p-8 border border-gray-100 hover:border-primary/30 hover:shadow-xl transition-all duration-500`}>
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {steps.map((step, index) => <div key={index} className={`animate-on-scroll animate-delay-${(index + 1) * 100} text-center`}>
                    <div className="relative mb-6">
                      <div className="w-20 h-20 mx-auto rounded-2xl bg-primary/10 flex items-center justify-center">
                        <span className="text-3xl font-bold text-primary">{step.number}</span>
                      </div>
                      {index < steps.length - 1 && <div className="hidden md:block absolute top-1/2 left-full w-full h-0.5 bg-primary/20 -translate-y-1/2" />}
                    </div>
          ...
          <div className="container-custom">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {testimonials.map((testimonial, index) => <div key={index} className={`animate-on-scroll animate-delay-${(index + 1) * 100} bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-all duration-300`}>
