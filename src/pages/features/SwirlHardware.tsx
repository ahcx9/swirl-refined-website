...
const SwirlHardware = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="pt-24 md:pt-28 pb-16 bg-white relative overflow-hidden">
            ...
            <div className="text-center animate-on-scroll max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <div className="btn-conteiner scale-90">
                  <a className="btn-content" href="https://wa.me/971543853877?text=Hi%2C%20I%20would%20like%20to%20book%20a%20demo%20for%20Swirl%20Hardware" target="_blank" rel="noopener noreferrer">
                ...
                <a href="#pos-section" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-primary font-bold rounded-full border-2 border-primary/20 hover:border-primary/40 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  Explore Hardware
