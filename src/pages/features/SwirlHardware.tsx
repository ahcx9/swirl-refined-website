          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
                Swirl POS Hardware Solutions
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl">
                Everything you need to run your restaurant efficiently. From tablets to printers, 
                payment terminals to kitchen displays - all optimized for Swirl POS.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center md:justify-start">
                <Button 
                  asChild 
                  className="bg-gradient-to-r from-swirl-blue to-blue-500 hover:from-swirl-blue/90 hover:to-blue-600 text-white rounded-xl px-5 py-3 md:px-6 md:py-3.5"
                >
                ...
                <Button 
                  asChild 
                  variant="outline"
                  className="rounded-xl px-5 py-3 md:px-6 md:py-3.5"
                >
            ...
            <div className="order-first md:order-last">
              <img 
                ...
                alt="Swirl POS Hardware - Tablets, Printers, and Payment Terminals" 
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Professional-grade equipment designed for the demanding restaurant environment
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {hardwareItems.map((item, index) => (
              <div 
                key={index}
                className="rounded-2xl border border-black/10 shadow-sm p-5 md:p-6 hover:shadow-lg transition-all duration-300"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="rounded-2xl border border-black/10 shadow-sm p-6 md:p-8 bg-white">
              ...
              <div className="space-y-3">
                <Button 
                  asChild 
                  className="w-full bg-gradient-to-r from-swirl-blue to-blue-500 hover:from-swirl-blue/90 hover:to-blue-600 text-white rounded-xl px-5 py-3 md:px-6 md:py-3.5"
                >
                  <a href="https://wa.me/971543853877" target="_blank" rel="noopener noreferrer">
                    Request a Quote
                  </a>
                ...
                <Button 
                  asChild 
                  variant="outline"
                  className="w-full rounded-xl px-5 py-3 md:px-6 md:py-3.5"
                >
                  <a href="/contact">
                    Schedule a Demo
                  </a>
