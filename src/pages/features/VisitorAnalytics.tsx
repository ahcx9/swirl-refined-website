      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
            ...
            <p className="font-bold text-gray-900 text-2xl">33</p>
          </div>
          ...
          <div className="bg-green-50 rounded-xl p-4 border border-green-100">
            ...
            <p className="font-bold text-gray-900 text-2xl">24</p>
          </div>
          ...
          <div className="bg-purple-50 rounded-xl p-4 border border-purple-100">
            ...
            <p className="font-bold text-gray-900 text-2xl">9</p>
          </div>
          ...
          <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
            ...
            <p className="font-bold text-gray-900 text-2xl">27.27%</p>
          </div>
        </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <div className="animate-on-scroll inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full mb-6 border border-primary/20">
                  ...
                  <span className="text-base md:text-sm font-bold md:font-semibold text-primary">QR Scan Analytics</span>
                </div>
