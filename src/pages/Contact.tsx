...
Message: ${formData.message}
  ...
  return <div className="min-h-screen flex flex-col bg-white font-inter">
      <Navbar />
        ...
        <section className="relative py-20 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center max-w-4xl mx-auto">
              <div className="inline-flex items-center gap-3 bg-swirl-blue/10 text-swirl-blue px-6 py-3 rounded-full mb-6 font-medium">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="order-2 lg:order-1">
                <Card className="bg-white shadow-lg border border-gray-100">
                  <CardContent className="p-0">
                    <div className="bg-swirl-blue p-8 text-white">
                      ...
                      <p className="text-white/90">Tell us about your restaurant/cafe and we'll show you how swirl can help you in operations.</p>
                    </div>
                    
                    <div className="p-8">
                      {submitted ? <div className="text-center py-12">
                          <div className="w-16 h-16 bg-swirl-blue/10 rounded-full flex items-center justify-center mx-auto mb-4">
                            <CheckCircle className="text-swirl-blue" size={32} />
                          </div>
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                              ...
                              <select id="businessType" name="businessType" required value={formData.businessType} onChange={handleChange} className="mt-2 w-full h-10 px-3 py-2 border border-gray-200 rounded-md focus:border-swirl-blue focus:ring-swirl-blue focus:outline-none">
              ...
              <div className="order-1 lg:order-2 space-y-8">
                <div>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">Ready to revolutionize your restaurant operations? Our team is here to help you streamline your restaurant/cafe and boost your profits with swirl's comprehensive platform.</p>
                </div>

                {/* Contact Cards */}
                <div className="space-y-4">
                  <Card className="border-l-4 border-l-swirl-blue shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="p-3 bg-swirl-blue/10 rounded-lg">
                          <Phone className="text-swirl-blue" size={24} />
                        </div>
                        <div>
                          <h3 className="font-semibold text-gray-900 mb-2">Call Us</h3>
                          <a href="tel:+971543853877" className="text-swirl-blue hover:text-blue-700 font-medium text-lg">
                            +971 54 385 3877
                          </a>
                  ...
                  <Card className="border-l-4 border-l-swirl-blue shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="p-3 bg-swirl-blue/10 rounded-lg">
                          <Mail className="text-swirl-blue" size={24} />
                        </div>
                        <div>
                          <h3 className="font-semibold text-gray-900 mb-2">Email Us</h3>
                          <a href="mailto:hello@swirl.cx" className="text-swirl-blue hover:text-blue-700 font-medium text-lg">
                            hello@swirl.cx
                          </a>
                  ...
                  <Card className="border-l-4 border-l-swirl-blue shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="p-3 bg-swirl-blue/10 rounded-lg">
                          <MapPin className="text-swirl-blue" size={24} />
                        </div>
                        <div>
                ...
                {/* WhatsApp CTA */}
                <Card className="bg-swirl-blue text-white border-0">
                  <CardContent className="p-6">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.linkedin.com/company/swirl-cx" className="text-swirl-blue hover:text-blue-700 font-medium">
                      LinkedIn
                    </a>
                    <a href="https://www.instagram.com/swirl.cx?igsh=MTk4dDZlOTZqNHFjcg%3D%3D&utm_source=qr" className="text-swirl-blue hover:text-blue-700 font-medium">
                      Instagram
                    </a>
