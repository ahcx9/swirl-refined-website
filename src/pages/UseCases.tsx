        ...
        <section className="bg-gradient-to-br from-blue-100/60 to-indigo-100/50 py-20">
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 font-inter text-blue-800">Use Cases</h1>
                ...
                <Card key={segment.title} className={`overflow-hidden transform transition-all duration-500 hover:scale-105 hover:rotate-1 border-2 ${segment.borderColor} rounded-xl`}>
                  ...
                  <CardHeader className="relative z-10">
                    <div className="flex items-center gap-4 mb-3">
                      ...
                      <CardTitle className="font-inter text-2xl text-blue-900">{segment.title}</CardTitle>
                    </div>
                    <CardDescription className="font-inter mt-2 text-base text-blue-700/80">{segment.description}</CardDescription>
                  </CardHeader>
                </Card>
              ))}
            </div>
