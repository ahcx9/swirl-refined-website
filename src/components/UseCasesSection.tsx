...
import { Truck, Utensils, Coffee, Store, Building, ChefHat, Hotel } from 'lucide-react';
type UseCaseType = {
  id: string;
  title: string;
  description: string;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          boxShadow: hoveredCase === useCase.id ? '0 20px 30px -10px rgba(59, 130, 246, 0.2)' : '0 4px 6px -1px rgba(59, 130, 246, 0.1)'
              ...
              <div className="absolute inset-0 opacity-10">
                {useCase.pattern === 'dots' && <div className="absolute inset-0" style={{
              backgroundImage: 'radial-gradient(circle, currentColor 1px, transparent 1px)',
              backgroundSize: '12px 12px'
            }}></div>}
                {useCase.pattern === 'radial' && <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_30%,_currentColor_70%)] opacity-5"></div>}
                {useCase.pattern === 'linear' && <div className="absolute inset-0" style={{
              ...
              backgroundSize: '20px 20px'
                ...
                {useCase.pattern === 'zigzag' && <div className="absolute inset-0" style={{
              ...
              backgroundSize: '20px 40px'
                ...
                {useCase.pattern === 'wave' && <div className="absolute inset-0" style={{
              ...
              backgroundSize: '80px auto'
                ...
                {useCase.pattern === 'circles' && <div className="absolute inset-0" style={{
