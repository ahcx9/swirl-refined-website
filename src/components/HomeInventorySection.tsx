...
const HomeInventorySection = () => {
  const features = [
    ...
    { icon: Tag, text: 'Automated low-stock alerts' },
    { icon: List, text: 'Supplier management' },
    { icon: BarChart, text: 'Waste monitoring & reporting' },
    { icon: HardDrive, text: 'Ingredient-level tracking' }
  ];

  return (
    <section className="py-16 overflow-hidden relative bg-gradient-to-br from-indigo-50/30 to-white">
