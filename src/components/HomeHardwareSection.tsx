        ...
        <div className="grid md:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="md:col-span-5 order-2 md:order-2">
            <div className="animate-on-scroll">
              <div className="inline-block px-4 py-2 bg-blue-50 text-swirl-blue rounded-full text-sm font-semibold mb-4 border border-blue-100">
                HARDWARE SOLUTIONS
              </div>
              
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-swirl-blue font-inter">
              ...
              <div className="grid grid-cols-1 gap-3 mb-10">
                {hardwareFeatures.map((feature, index) => (
                  <Card key={index} className="bg-white border border-blue-100 shadow-sm hover:shadow-md transition-all duration-300">
                    <CardContent className="p-4 flex items-start gap-3">
                      <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0">
                        <feature.icon className="w-5 h-5 text-swirl-blue" />
                      </div>
                      <div>
