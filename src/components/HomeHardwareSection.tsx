            ...
            <Card className="overflow-hidden border-0 shadow-2xl rounded-2xl bg-white mx-auto">
              <CardContent className="p-0">
                <div className="relative">
                  <img src="/lovable-uploads/pos-hardware-setup.png" alt="swirl Complete Hardware Setup" className="w-full h-auto rounded-xl object-cover" loading="lazy" decoding="async" style={{
