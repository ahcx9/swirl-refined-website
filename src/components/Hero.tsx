                ...
                {images.map((image, index) => <CarouselItem key={index}>
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-b from-blue-100/50 to-white p-2">
                      <AspectRatio ratio={16 / 9}>
                        <img src={image} alt={`Restaurant management system ${index + 1}`} className="w-full h-full object-contain mx-auto rounded-xl" loading={index === 0 ? "eager" : "lazy"} fetchPriority={index === 0 ? "high" : "auto"} style={{
                    maxHeight: '55vh',
