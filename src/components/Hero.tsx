...
const Hero: React.FC = () => {
  ...
  return <>
    ...
    {/* Section 3: Interactive POS Mockup — full dashboard on PC/tablet, compact billing on mobile */}
    <section className="relative bg-white overflow-hidden pb-10 md:pb-20">
      <SketchyRestaurantBackground />
      <div className="container-custom relative z-10">
        {/* Mobile only: compact billing mockup */}
        <div className="md:hidden max-w-xl mx-auto">
          <div className="flex items-center justify-center gap-3 flex-wrap mb-5">
             <div className="flex items-center gap-2 px-5 py-2 bg-primary/5 rounded-full border border-primary/15">
        ...
        {/* Tablet & desktop: full interactive dashboard */}
