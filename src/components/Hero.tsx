        ...
        <div className="text-center max-w-5xl mx-auto mb-8">
          ...
          <div className="flex justify-center">
            <Button 
              asChild 
              size="lg"
              className="text-lg py-6 px-8 bg-gradient-to-r from-swirl-blue to-blue-500 rounded-xl shadow-lg hover:shadow-blue-300/30 transition-all duration-300 transform hover:-translate-y-1"
            >
