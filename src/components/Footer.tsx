    ...
    <footer className="bg-purple-dark text-white">
      ...
      <div className="container mx-auto py-14 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-3">
              <a
                ...
                className="bg-white/10 hover:bg-purple p-2 rounded-full transition-colors"
                aria-label="LinkedIn"
              >
                <svg
                  width="18"
          ...
          {/* Use Cases */}
          <div>
            <h3 className="text-base font-semibold mb-4 relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-1 after:w-8 after:bg-purple after:-mb-2">
              Use Cases
            </h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  ...
                  className="text-white/70 hover:text-purple transition-colors inline-block"
                >
                  Fine Dining
                </Link>
              </li>
              ...
              <li>
                <Link to="/use-cases#cafes" className="text-white/70 hover:text-purple transition-colors inline-block">
                  Cafés
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:hello@swirl.cx" className="text-white/70 hover:text-purple transition-colors">
                  hello@swirl.cx
                </a>
              </li>
            </ul>
