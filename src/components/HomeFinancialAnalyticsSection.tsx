                ...
                <div className="relative">
                  ...
                  <div className="perspective-1000">
                    <div className="transform transition-all duration-700 hover:scale-[1.02]">
                      <img src="/lovable-uploads/459383dc-eff1-410b-af47-ff49a9a0a01e.png" alt="Financial Analytics Dashboard" loading="eager" className="w-full h-auto rounded-lg shadow-inner object-scale-down" />
