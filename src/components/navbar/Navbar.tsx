...
const Navbar = () => {
  ...
  const mainLinks = [
    ...
    { name: 'POS Hardware', path: '/products/pos-hardware' },
    ...
    >
      <div className="max-w-[1800px] mx-auto px-4 xl:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button asChild variant="secondary" className="bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#128C7E] hover:to-[#25D366] text-white border-0 rounded-full h-11 px-5 flex items-center gap-2 font-inter shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
