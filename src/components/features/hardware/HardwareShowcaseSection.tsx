      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <img 
                  ...
                  className="rounded-2xl shadow-2xl w-full max-w-xl h-auto mx-auto hover:scale-105 transition-transform duration-500"
                />
              </div>
              ...
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full shadow-lg transform rotate-12 hover:rotate-0 transition-transform duration-300">
                <span className="font-bold text-sm">Enterprise Grade</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 animate-on-scroll">
            {[
              { icon: CheckCircle, title: 'Multi Screen Options Point-of-Sale', desc: 'Flexible display options for any restaurant size' },
              { icon: Zap, title: 'Windows OS Compatible', desc: 'Full Windows OS support with enterprise features' },
              { icon: Package, title: 'iPad Compatible', desc: 'Seamlessly works with iPad and iOS devices' },
              { icon: Clock, title: '24/7 Technical Support', desc: 'Always here when you need assistance' }
            ].map((feature, idx) => (
              <div key={idx} className="flex gap-4 p-5 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200 shadow-md hover:shadow-xl hover:border-blue-300 transition-all duration-300 group">
