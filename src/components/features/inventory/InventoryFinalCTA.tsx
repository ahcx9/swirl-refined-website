        ...
        >
          ...
          <div className="relative">
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Stop guessing.
              <br />
              Start running on truth.
            </h2>
            <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto">
              Replace the spreadsheets, the side tools, and the blind spots — with one operating system for your inventory.
            </p>
...
export default InventoryFinalCTA;
