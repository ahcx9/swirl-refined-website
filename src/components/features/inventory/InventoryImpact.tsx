...
const stats = [
  { value: 40, suffix: '%', label: 'Less wastage', desc: 'On average across rollouts' },
  { value: 6, suffix: 'pp', label: 'Margin recovered', desc: 'Through tighter food cost' },
  { value: 90, suffix: '%', label: 'Faster procurement', desc: 'PO to GRN to invoice' },
  { value: 100, suffix: '%', label: 'Cost accuracy', desc: 'Real-time per dish' },
];
