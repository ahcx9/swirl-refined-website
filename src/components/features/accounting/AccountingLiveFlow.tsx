...
import { TrendingUp, Receipt, Banknote, BookOpen, BarChart3, CreditCard } from 'lucide-react';
import { useCurrency } from '@/hooks/useCurrency';

const AccountingLiveFlow = () => {
  ...
  const net = (amount - amount * vatRate).toFixed(2);
    ...
    <section ref={ref} className="py-24 bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white relative overflow-hidden">
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-400">No batch jobs. No spreadsheets. No waiting.</p>
        </div>
          ...
          <div className="lg:col-span-4">
            ...
            >
              ...
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="px-3 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-lg text-xs text-emerald-300 font-mono"
              >
                Txn #{(8421 + tick).toString().padStart(6, '0')} • settled
              </motion.div>
              <p className="text-sm text-gray-400 mt-6 leading-relaxed">
                One swipe at the POS triggers five postings across the ledger — automatically.
              </p>
            </motion.div>
          </div>
...
export default AccountingLiveFlow;
