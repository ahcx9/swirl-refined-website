        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto">
              Replace your accounting silo with a finance system that runs in the same heartbeat as your restaurant.
            </p>
...
export default AccountingFinalCTA;
