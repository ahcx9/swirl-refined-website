...
const POSBenefits = () => {
  return <div className="bg-gradient-to-r from-purple-light/30 to-purple/10 p-8 md:p-10 rounded-xl mb-16">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <BenefitCard icon={<Clock className="text-purple h-6 w-6 shrink-0" />} title="Save Time" description="Streamline operations and reduce manual tasks with automation features that give you more time to focus on your customers." />
