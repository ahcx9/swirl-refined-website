...
const POSCallToAction = () => {
  return <div className="bg-gradient-to-r from-purple-light/30 to-purple/10 rounded-xl p-8 md:p-10 shadow-soft text-center mb-8 border border-purple-light/20">
