...
const FeatureCard = ({ title, description, icon, colorClass, iconBgClass, index }: FeatureCardProps) => {
  const delayAnimation = `${index * 0.1}s`;
  
  return (
    <Card className={`overflow-hidden transition-all duration-500 hover:scale-105 hover:rotate-1 border-none ${colorClass} h-full shadow-lg hover:shadow-xl rounded-xl`}>
      <div className="p-6 relative" style={{ animationDelay: delayAnimation }}>
...
const NextGenFeatures = () => {
  ...
  return (
    <section id="next-gen-features" className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="container-custom">
        ...
        <div className="mt-12 text-center">
          <Link 
            to="/products" 
            className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-medium py-3 px-8 rounded-full transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
          >
