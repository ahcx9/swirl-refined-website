...
const businessTypes = [
  {
    ...
    kpis: [
      { label: 'Avg. Checkout', value: '12s', icon: Clock },
  ...
  },
  {
    ...
    kpis: [
      ...
      { label: 'Order Accuracy', value: '99.8%', icon: DollarSign },
    ],
  },
  {
    id: 'finedining',
  ...
  },
  {
    ...
    kpis: [
      { label: 'Brands', value: '∞', icon: Building2 },
      { label: 'Delivery Sync', value: 'Real-time', icon: TrendingUp },
    ],
  },
  {
    id: 'foodtruck',
    ...
    kpis: [
      ...
      { label: 'Setup Time', value: '30s', icon: TrendingUp },
    ],
  },
  {
    id: 'hotel',
    ...
    kpis: [
      { label: 'Outlets', value: 'Unlimited', icon: Building2 },
      { label: 'Reporting', value: 'Central', icon: DollarSign },
    ],
  },
];
  ...
  return (
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      <div className="container-custom relative z-10">
        ...
        <div className="mb-10 animate-on-scroll">
          ...
          <div className="hidden md:flex items-center justify-center gap-2">
            {businessTypes.map((type) => (
              ...
              >
                <type.icon className={`w-5 h-5 ${activeType.id === type.id ? 'text-white' : 'text-primary'}`} />
        ...
        {/* Showcase — Left image, Right content */}
        <div className={`max-w-6xl mx-auto transition-all duration-150 ease-out ${isTransitioning ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0'}`}>
          <div className="grid lg:grid-cols-5 gap-0 bg-white rounded-3xl border border-gray-100 shadow-2xl shadow-gray-200/50 overflow-hidden">
            {/* Left: Large Image (3 cols) */}
            <div className="relative lg:col-span-3 h-72 lg:h-auto min-h-[420px]">
              <img 
        ...
        <div className="mt-12 text-center animate-on-scroll">
          <Link
            to="/use-cases"
            className="inline-flex items-center gap-2 px-7 py-3.5 bg-primary text-white rounded-full font-medium hover:bg-primary/90 transition-all shadow-lg shadow-primary/25"
          >
