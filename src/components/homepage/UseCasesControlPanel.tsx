...
const UseCasesControlPanel: React.FC = () => {
  ...
  const businessTypes = [
    {
      ...
      kpis: [
        { label: 'Avg Transaction', value: formatAmount(280) },
    ...
    },
    {
      ...
      kpis: [
        { label: 'Avg Cover', value: formatAmount(2400) },
    ...
    },
    {
      ...
      kpis: [
        { label: 'Daily Sales', value: formatAmount(18500) },
    ...
    },
    {
      ...
      kpis: [
        ...
        { label: 'F&B Revenue', value: formatAmount(320000) },
      ],
  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50/30 to-white relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-10 animate-on-scroll">
        ...
        `}>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-2xl shadow-gray-100/50 overflow-hidden">
            {/* Dashboard Header */}
            <div className="bg-gradient-to-r from-primary to-blue-600 px-5 py-3.5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <activeType.icon className="w-4 h-4 text-white" />
                <span className="text-white font-semibold text-sm">Swirl for {activeType.name}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                <span className="text-white/80 text-xs hidden sm:inline">Live Preview</span>
              </div>
            </div>

            <div className="grid lg:grid-cols-5 gap-0">
              {/* Left: Image */}
              <div className="lg:col-span-2 relative h-56 lg:h-80">
                <img 
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/70 to-transparent">
                  <p className="text-white text-sm leading-relaxed">{activeType.description}</p>
                </div>
              </div>

              {/* Right: Dashboard */}
              <div className="lg:col-span-3 p-5 md:p-7 bg-gradient-to-br from-gray-50/50 to-white">
                {/* KPIs */}
                <div className="grid grid-cols-3 gap-3 mb-5">
                  {activeType.kpis.map((kpi, i) => (
                    <div key={i} className="bg-white rounded-xl border border-gray-100 p-3 text-center hover:border-primary/20 hover:shadow-lg transition-all duration-300">
